...
| <a name="module_vpc_develop"></a> [vpc\_develop](#module\_vpc\_develop) | ./modules/vpc | n/a |
...
| <a name="input_image_family"></a> [image\_family](#input\_image\_family) | name image os | `string` | `"ubuntu-2004-lts"` | no |
